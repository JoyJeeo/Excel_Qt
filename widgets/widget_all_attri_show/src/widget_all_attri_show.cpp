...
Widget_All_Attri_Show::Widget_All_Attri_Show(QWidget *parent) : QWidget(parent)
{
        resize(800,800);
...
void Widget_All_Attri_Show::while_draw(Valid_Data datas)
{
...
void Widget_All_Attri_Show::draw()
{
