...
Button_Merge_File::~Button_Merge_File()
{

}

void Button_Merge_File::total_task()
{
    /*
        设置按钮样式，并进行信号关联
    */
...
//        font.setBold(true);
        ...
        qDebug() << "Button_Merge_File::total_task";
        throw;
    }
}

void Button_Merge_File::task_widget_merge_datas_show()
{
    /*
        按钮的任务
        // 这里暂时先不管内存泄漏的问题
...
QStringList Button_Merge_File::construct_input_file_paths() noexcept
{
...
void Button_Merge_File::construct_widgets_file_paths()
{
    try {
        // 将容器先清空
        ...
        flage = widget->merge_task(input_file_paths);
        // 任务成功
        // 使用非模态窗口实现
        if(flage){
            // 将创建好的窗体添加到widgets中
        ...
        qDebug() << "Button_Merge_File::get_attri_widgets_filepath";
        throw ;
    }
}

void Button_Merge_File::construct_main_widge()
{
    try {
        // 容纳所有widget
        ...
        qDebug() << "Button_Merge_File::construct_main_widge";
        throw;
    }
}

void Button_Merge_File::construct_scrollarea()
{
    try {
        // 构造QScrollArea
...
//        scrollarea->resize(595,842); // A4
        ...
        qDebug() << "Button_Merge_File::construct_scrollarea";
        throw ;
    }
}

void Button_Merge_File::save_pic(QWidget *saved_widget, const QString &saved_path)
{
    try {
        // 抓取窗口生成图片并保存
        ...
        qDebug() <<"Button_Merge_File::save_pic";
        throw ;
    }
}
