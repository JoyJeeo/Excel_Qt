...
void File_To_Targetfile::set_output_file_path(const string &path)
{
    OUT_FILE_PATH = path;
}

string File_To_Targetfile::get_output_file_path()
{
    return OUT_FILE_PATH;
}

void File_To_Targetfile::set_input_file_path(const string &path)
{
    IN_FILE_PATH = path;
}

string File_To_Targetfile::get_input_file_path()
{
    return IN_FILE_PATH;
}
