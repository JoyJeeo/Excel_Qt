#include "tools/include/data_profile/Targetfile_Time_Valid_Data.h"
...
Targetfile_Time_Valid_Data::Targetfile_Time_Valid_Data()
{
...
void Targetfile_Time_Valid_Data::total_task(const string target_file_path)
{
    try {
        // 获取数据输入流
        ...
        qDebug() << "Targetfile_Time_Valid_Data::total_task";
        throw   ;
    }
}

pair<double, double> Targetfile_Time_Valid_Data::get_attri_value_XI(const string &attri) noexcept
{
...
pair<double, double> Targetfile_Time_Valid_Data::get_attri_define_XI(const string &attri) noexcept
{
    return make_pair(m_uul.m_attri_uuls[attri].m_LimitL,m_uul.m_attri_uuls[attri].m_LimitU);
}

vector<vector<string> > Targetfile_Time_Valid_Data::get_timc_target_file_vec() noexcept
{
    return m_all_array;
}

vector<string> Targetfile_Time_Valid_Data::get_scatter_site()
{
    try {
        return m_site_part.get_scatter_string_site();

    } catch (...) {
        qDebug() << "Targetfile_Time_Valid_Data::get_scatter_site";
        throw;
    }
}

vector<string> Targetfile_Time_Valid_Data::get_scatter_part()
{
    try {
        return m_site_part.get_scatter_string_part();

    } catch (...) {
        qDebug() << "Targetfile_Time_Valid_Data::get_scatter_part";
        throw;
    }
}

map<string, int> Targetfile_Time_Valid_Data::get_part_map() noexcept
{
    return m_part_map;
}

string Targetfile_Time_Valid_Data::get_attri_unit(const string &attri) noexcept
{
    return m_uul.m_attri_uuls[attri].m_Unit;
}

map<string, map<string, map<string, double>>> Targetfile_Time_Valid_Data::get_series_datas() noexcept
{
    return m_series_data;
}

const vector<string> Targetfile_Time_Valid_Data::get_labels() noexcept
{
    return labels;
}

ifstream Targetfile_Time_Valid_Data::input_file_open(const string &input_file_path)
{
    try {
        ifstream ifs;
        ...
        qDebug() << "Targetfile_Time_Valid_Data::input_file_open";
        throw;
    }
}

void Targetfile_Time_Valid_Data::load_target_file(const ifstream &ifs)
{
    try {
        string s;
        ...
        qDebug() << "Targetfile_Time_Valid_Data::load_target_file";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_head_body_div()
{
    try {
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_head_body_div";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_valid_col()
{
    try {
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_valid_col";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_valid_datas()
{
    try {
        profile_site_part();
        profile_uul();
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_valid_datas";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_labels()
{
    try {
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_labels";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_site_part()
{
    try {
        int attri_col = 0;
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_site_part";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_uul()
{
    try {
        size_t uul_index = 0;
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_uul";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_series_data()
{
    try {
        // 初始化
        vector<string> scatter_site = m_site_part.get_scatter_string_site();
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_series_data";
        throw;
    }
}

void Targetfile_Time_Valid_Data::profile_part_map()
{
    try {
        ...
        qDebug() << "Targetfile_Time_Valid_Data::profile_part_map";
        throw;
    }
}

size_t Targetfile_Time_Valid_Data::get_row_index_by_attri(const string &attri)
{
    try {
        size_t i;
        for(i = 0;i < m_all_array.size();i++)
        ...
        qDebug() << "Targetfile_Time_Valid_Data::get_row_index_by_attri";
        throw;
    }
}
