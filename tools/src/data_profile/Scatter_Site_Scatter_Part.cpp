#include "tools/include/data_profile/Scatter_Site_Scatter_Part.h"


Scatter_Site_Scatter_Part::Scatter_Site_Scatter_Part()
{
    m_attri_site_part.insert(make_pair(SITE_NUM,vector<string>()));
    m_attri_site_part.insert(make_pair(PART_ID,vector<string>()));
}

vector<string> Scatter_Site_Scatter_Part::get_site_list()
{
    return m_attri_site_part[SITE_NUM];
}

vector<string> Scatter_Site_Scatter_Part::get_part_list()
{
    return m_attri_site_part[PART_ID];
}

vector<string> Scatter_Site_Scatter_Part::get_scatter_string_site()
{
    try {
        ...
        qDebug() << "Scatter_Site_Scatter_Part::get_scatter_string_site";
        throw;
    }
}

vector<int> Scatter_Site_Scatter_Part::get_scatter_int_site()
{
    /*
...
vector<int> Scatter_Site_Scatter_Part::get_scatter_int_part()
{
    try {
        vector<int> parts;
        ...
        qDebug() << "Scatter_Site_Scatter_Part::get_x_part";
        throw;
    }
}

vector<string> Scatter_Site_Scatter_Part::get_scatter_string_part()
{
    try {
        vector<string> parts;
        vector<string> part_list = get_part_list();
        ...
        for(string part_str : part_list)
        {
            if(find(parts.begin(),parts.end(),part_str) == parts.end())
            {
