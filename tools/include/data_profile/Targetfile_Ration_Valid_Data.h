#ifndef TARGETFILE_RATION_VALID_DATA_H
#define TARGETFILE_RATION_VALID_DATA_H
...
class Targetfile_Ration_Valid_Data
{
public:
    Targetfile_Ration_Valid_Data();
    ~Targetfile_Ration_Valid_Data();
...
#endif // TARGETFILE_RATION_VALID_DATA_H
